...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            <!--begin::Search-->
            <form action="{{ route('reservasiOperator.index') }}" method="get">
                        ...
                        <table id="kt_datatable_example_4" class="table table-striped table-row-bordered gy-5 gs-7">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if ($reservasi->fileBuktiTf != null)
                                                    <a href="storage/{{$reservasi->fileBuktiTf}}"
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('reservasiOperator.edit', $reservasi) }}" class="menu-link px-3">Ubah Status</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
