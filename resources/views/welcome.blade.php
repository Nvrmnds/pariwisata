...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <p><i class="fa fa-envelope mr-2"></i>KyTravel@gmail.com</p>
                        <p class="text-body px-3">|</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+62 895 2748 1818</p>
                    </div>
                </div>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-primary"><span class="text-dark">Ky</span>Travel</h1>
                </a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">KyTravel</h4>
                            <h1 class="display-3 text-white mb-md-4">Mari Jelajahi Dunia Bersama</h1>
                            <a href="{{ route('login') }}" class="btn btn-primary py-md-3 px-md-5 mt-2">Pesan Sekarang</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Tentang</h6>
                        <h1 class="mb-3">Kami Menyediakan Paket Wisata Terbaik</h1>
                        <p>Buka keindahan dunia di ujung jari Anda. Platform web kami mengundang Anda untuk menjelajahi, membenamkan, dan jatuh cinta dengan keajaiban pariwisata.</p>
                        <div class="row mb-4">
                            <div class="col-6">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-primary mt-1">Pesan Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                ...
                <h1>Jelajahi Destinasi Terpopuler</h1>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        ...
                        <a class="destination-overlay text-white text-decoration-none" href="#">
                            ...
                            <span>60 Destinasi</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/rajaampat.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="#">
                            <h5 class="text-white">Raja Ampat</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/bunaken.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="#">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/danautoba.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="#">
                            <h5 class="text-white">Danau toba</h5>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Daftar Paket</h6>
                <h1>Daftar Paket Menarik</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket1.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Bali</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 hari</small>
                            </div>
                            <h5>Temukan tempat-tempat menakjubkan di dunia bersama kami</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket2.jpeg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Jogja</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i> 5 hari</small>
                            </div>
                            <h5>Temukan tempat-tempat menakjubkan di dunia bersama kami</h5>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket3.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Raja Ampat</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>4 hari</small>
                            </div>
                            <h5>Temukan tempat-tempat menakjubkan di dunia bersama kami</h5>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket4.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Bunaken</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 hari</small>
                            </div>
                            <h5>Temukan tempat-tempat menakjubkan di dunia bersama kami</h5>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.3 <small></small></h6>
                                    <a href="{{ route('login') }}" class="btn btn-primary">Pesan Sekarang</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket5.jpeg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/paket6.jpeg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Danau Toba</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>4 hari</small>
                            </div>
                            <h5>Temukan tempat-tempat menakjubkan di dunia bersama kami</h5>
                            <div class="border-top mt-4 pt-4">
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <!-- <a href="" class="navbar-brand">
                    <h1 class="text-primary"><span class="text-white">Explore</span>X</h1>
                </a>
                <p>Buka keindahan dunia di ujung jari Anda. Platform web kami mengundang Anda untuk menjelajahi, membenamkan, dan jatuh cinta dengan keajaiban pariwisata.</p> -->
            ...
            <div class="row">
                <p>
                  <i class="fa fa-map-marker-alt mr-2"></i>Jawa Barat, Kab. Bogor, Kec. Cibinong -  
                  <i class="fa fa-phone-alt mr-2"></i>+62 895 2748 1818 - 
                  <i class="fa fa-envelope mr-2"></i>KyTravel@gmail.com
                </p>
            </div>
        </div>
    </div>
