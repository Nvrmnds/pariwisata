            ...
            <div class="d-flex flex-column flex-row-auto w-100 h-100">
                <div class="d-flex flex-column h-50 w-100 bg-dark flex-center">
                    ...
                    <div class="text-center mb-5">
                        <img alt="Logo" src="{{ asset('img/KyTravel-logo-white.png') }}" class="mb-10" />
                        <!--begin::Title-->
                        <h4 class="text-light mb-3 fs-3">Selamat Datang <br> di KyTravel</h4>
                        <!--end::Title-->
                    </div>
                    <!--begin::Heading-->
                </div>
                ...
                <div class="d-flex flex-column-fluid bg-dark flex-center">
                    <img alt="Logo"
                            src="{{ asset('img/ilustration-kytravel-2.png') }}"
                            class="h-400px" />
                    <!-- <img alt="Logo"
                        src="{{ asset('themes/metronic-demo9/media/illustrations/sketchy-1/5-dark.png') }}"
                        class="h-400px" /> -->
                </div>
            </div>
        </div>
