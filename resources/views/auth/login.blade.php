            ...
            <div class="d-flex flex-column-fluid h-100 w-350px">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST"
                    ...
                    <div class="text-center mb-5">
                        <img alt="Logo" src="{{ asset('img/KyTravel-logo-black.png') }}" class="mb-10" />
                        <!--begin::Title-->
                        <h4 class="text-dark mb-3">Masuk ke KyTravel</h4>
                        <!--end::Title-->
                        <!--begin::Link-->
                        <div class="text-gray-400 fw-bold fs-4">Belum punya akun?
                            <a href="{{ route('register') }}" class="link-success fw-bolder">Daftar disini</a>
                        </div>
                        <!--end::Link-->
                    </div>
                    <!--begin::Heading-->
