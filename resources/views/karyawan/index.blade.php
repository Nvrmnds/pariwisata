                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('karyawan.edit', $karyawan) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->


                                            <!--begin::Delete button-->
                                            <form action="{{ route('karyawan.delete', $karyawan) }}" method="POST" id="deleteKaryawan{{ $karyawan->id }}">
                                                @method('delete')
                                                @csrf
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="onDelete({{$karyawan->id}}, '{{$karyawan->namaKaryawan}}')" class="menu-link px-3">Hapus</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </form>
                                            <!--end::Delete button-->
...
<script>
    ...
    function onDelete(id, name) {
        Swal.fire({
            ...
            document.getElementById('deleteKaryawan'+id).submit();
