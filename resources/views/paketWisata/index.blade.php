...
<div class="card overflow-scroll">
    ...
    <div class="card-header border-0 pt-6">
        <!--begin::Card title-->
        <div class="card-title overflow-scroll">
            <!--begin::Search-->
            <form action="{{ route('paketWisata.index') }}" method="get">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                <!--begin::Add customer-->
                <a href="{{ route('paketWisata.create') }}" class="btn btn-primary">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('paketWisata.edit', $paketWisata) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->


                                            <!--begin::Delete button-->
                                            <form action="{{ route('paketWisata.destroy', $paketWisata) }}" method="POST" id="deletePaketWisata{{ $paketWisata->id }}">
                                                @method('delete')
                                                @csrf
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a onclick="onDelete({{$paketWisata->id}}, '{{$paketWisata->namaPaket}}')" class="menu-link px-3">Hapus</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </form>
                                            <!--end::Delete button-->
...
<script>
    ...
    function onDelete(id, name) {
        Swal.fire({
            ...
            document.getElementById('deletePaketWisata'+id).submit();
